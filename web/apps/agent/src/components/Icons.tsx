// Professional Fintech SVG Icons for Watu Credit
// All icons are scalable and use the Watu color scheme
...
export const LogoutIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M10 3H6a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h4m7-5l5-5m0 0l-5-5m5 5H9"></path>
  </svg>
);
